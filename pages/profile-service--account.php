        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Form Elements">Other</div>
              </a>
            </li>
        ...
        <div class="layout-page">
          ...
          <!-- Content wrapper -->
           ...
           <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Account & Profile /</span> Profile #2</h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="./profile-service--other.php"
                        ><i class="bx bx-bell me-1"></i> Other</a
                      >
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Start Day at company</label>
                            <input class="form-control" type="text" name="lastName" id="lastName" value="01/01/2022 " />
                          </div>
                          <div class="mb-3 col-md-6">
