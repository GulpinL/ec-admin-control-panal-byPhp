        ...
        <div class="layout-page">
          ...
          <!-- Content wrapper -->
           ...
           <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Account & Profile /</span> Change Password</h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header">Old Password</h5>
                    <div class="card-body">
                      <div>
                    ...
                    <div class="card-body">
                      <div class="row mt-3">
                        <div class="d-grid gap-2 col-lg-6 mx-auto">
                          <button class="btn btn-primary btn-lg" type="button">Change Password</button>
